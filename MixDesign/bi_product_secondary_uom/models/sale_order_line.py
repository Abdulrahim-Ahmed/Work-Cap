...
class SaleOrderLine(models.Model):
    ...
    secondary_uom_id = fields.Many2one('uom.uom', compute='_quantity_secondary_compute', string="ALT UOM", readonly=False, store=True)
    secondary_quantity = fields.Float('ALT Qty', compute='_quantity_secondary_compute', digits='Product Unit of Measure',readonly=False, store=True)
