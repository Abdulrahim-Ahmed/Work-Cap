...
class StockPicking(models.Model):
    ...
    def button_validate(self):
        # Temporarily allow access to picking types during validation
        return super(StockPicking, self.sudo()).button_validate()

    def action_confirm(self):
        # Temporarily allow access to picking types during confirmation
        return super(StockPicking, self.sudo()).action_confirm()

    def action_assign(self):
        # Temporarily allow access to picking types during assignment
        return super(StockPicking, self.sudo()).action_assign()
