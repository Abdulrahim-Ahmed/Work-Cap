...
################################################################################
{
    ...
    'depends': ['base', 'product', 'mail', 'project', 'account', 'purchase', 'sale', 'stock', 'bi_product_secondary_uom'
        , 'auto_create_analytic'],
    'data': [
        ...
        'report/create_invoice.xml',
        'report/md_delivery_note.xml',
        'report/picking_list.xml',
        'report/invoice_without_payment.xml',
        'report/custom_header.xml',
        'views/purchase_freight_view.xml',
        'views/delivery_clearance_view.xml',
        'views/weight_to_sales.xml',
        'views/res_partner_vendor_id_view.xml',
