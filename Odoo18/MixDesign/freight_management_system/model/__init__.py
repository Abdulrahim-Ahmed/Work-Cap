...
from . import purchase_freight
from . import freight_management
from . import freight_management_line
from . import freight_stage
from . import freight_order_documents
from . import delivery_clearance
from . import weight_to_sales
from . import res_partner_vendor_id
