...
class StockQuant(models.Model):
	...
	secondary_uom_id = fields.Many2one('uom.uom', compute='_quantity_secondary_compute', string="ALT UOM", store=True)
	secondary_quantity = fields.Float('ALT Qty', compute='_quantity_secondary_compute', digits='Product Unit of Measure', store=True)
