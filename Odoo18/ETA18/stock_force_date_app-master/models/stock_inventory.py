...
class StockQuant(models.Model):
    ...
    def _get_inventory_fields_create(self):
        ...
        return ['product_id', 'location_id', 'lot_id', 'package_id', 'owner_id',
                'force_date'] + self._get_inventory_fields_write()
    ...
    def create(self, vals):
        ...
        if self._is_inventory_mode() and any(
            ...
            if not self.user_has_groups('stock_force_date_app-master.group_stock_force_date'):
    ...
    def _apply_inventory(self):
        ...
        if self.env.user.has_group('stock_force_date_app.group_stock_force_date'):
            for quant in self:
                moves = self.env['stock.move'].with_context(inventory_mode=False, force_date=quant.force_date).create(
                    move_vals)
        moves._action_done()
