...
class KSResConfigSettings(models.TransientModel):
    ...
    ks_payment_return_cash_send = fields.Boolean(string="Return Cheque if pay cash Send",
                                                 related='company_id.ks_payment_return_cash_send', readonly=False)
    ks_payment_cash_send = fields.Boolean(string="Payment Cash Send", related='company_id.x_ks_payment_cash_send',
                                          readonly=False)
