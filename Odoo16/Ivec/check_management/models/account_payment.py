...
class AccountPayment(models.Model):
    ...
    date_collection = fields.Date("Collection Date ", copy=False, default=fields.Date.today)
    ...
    is_debit_account = fields.Boolean()
    ...
    def _prepare_move_line_default_vals(self, write_off_line_vals=None):
        ...
        if isinstance(write_off_line_vals, list):
            # Handle the case where write_off_line_vals is a list (modify as needed)
            write_off_line_vals = {}
    ...
    def create_move_line_send_cheques(self, journal, debit_account):
        ...
        second_journal_line = {
            'account_id': self.debit_account.id if self.debit_account.id else debit_account.id,
            'partner_id': self.partner_id.id,
            'name': self.cheque_ref,
            'ref': self.cheque_no,
            'date_maturity': self.effective_date,
